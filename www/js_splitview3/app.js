...
A.init.then(() => {
  ...
  a2.createImageSurvey('P/SPT/WINTER2020-090GHZ', 'SPT Winter2020 090GHz', hipsDir090, 'equatorial', 5, {minCut:-0.1, maxCut:0.1, colormap:'viridis', imgFormat: 'fits'});
  a2.createImageSurvey('P/SPT/WINTER2020-150GHZ', 'SPT Winter2020 150GHz', hipsDir150, 'equatorial', 5, {minCut:-0.1, maxCut:0.1, colormap:'viridis', imgFormat: 'fits'});
  a2.createImageSurvey('P/SPT/WINTER2020-220GHZ', 'SPT Winter2020 220GHz', hipsDir220, 'equatorial', 5, {minCut:-0.1, maxCut:0.1, colormap:'viridis', imgFormat: 'fits'});
